        ...
        {mode === 'login' ? (
          ...
          <View style={styles.stack}>
            <Card>
              ...
              <Field label="Email" value={registerEmail} onChangeText={(value) => setRegisterEmail(normalizeEmail(value))} keyboardType="email-address" autoCapitalize="none" />
              <Field label="Telefone" value={phone} onChangeText={(value) => setPhone(formatPhone(value))} keyboardType="numeric" placeholder="(21) 99999-9999" />
              <Field label="CPF/CNPJ para o Asaas" value={documentNumber} onChangeText={(value) => setDocumentNumber(formatCpfCnpj(value))} keyboardType="numeric" placeholder="000.000.000-00" />
